...
| 2026-08-12 | Display-text wikilink backlink regression | `cd apps/backend && uv run --group dev pytest ../../tests/test_pages_backlinks.py -q`: 7 passed. Legacy graph sync now slugifies `[[Target Page|Target]]` before adding `REFERENCES` edges, matching canonical markdown projection behavior. |
