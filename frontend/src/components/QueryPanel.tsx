...
export default function QueryPanel() {
  ...
  async function handleSaveAsPage() {
    ...
    try {
      ...
      const page = await createPage(slug, titleLine, content);
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          <textarea
            ...
            className="flex-1 bg-transparent border rounded px-3 py-2 text-sm text-text-primary placeholder-text-muted focus:outline-none focus:border-accent/50 resize-none"
            style={{ borderColor: '#3a3a4a' }}
          />
          <button
            type="submit"
            disabled={loading || !question.trim()}
            className="shrink-0 px-4 py-2 rounded text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed self-end"
            style={{
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {answer && (
          <div className="max-w-3xl">
            ...
            {/* Actions */}
            {!loading && (
              <div className="mt-6 pt-4 border-t flex items-center gap-3" style={{ borderColor: '#3a3a4a' }}>
                {savedSlug ? (
                  <button
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="text-sm px-3 py-1.5 rounded border border-accent/50 text-accent hover:bg-accent/10 transition-colors disabled:opacity-50"
                  >
